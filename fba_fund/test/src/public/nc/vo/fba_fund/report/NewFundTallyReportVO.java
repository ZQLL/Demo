...
import com.ufsoft.script.expression.UFDoubleOperand;
 ...
 */
public class NewFundTallyReportVO extends SuperVO {
	/**
     * 
     */
	 ...
	 * 资金成本率
	 */
	public UFDouble costrate_capital;
	/**
	 * 日均占有
	 */
	public UFDouble daily_possession;
	...
	public UFDouble getCostrate_capital() {
		return costrate_capital;
	}

	public void setCostrate_capital(UFDouble costrate_capital) {
		this.costrate_capital = costrate_capital;
	}

	public UFDouble getDaily_possession() {
		return daily_possession;
	}

	public void setDaily_possession(UFDouble daily_possession) {
		this.daily_possession = daily_possession;
	}
