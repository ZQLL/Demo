...
public interface IDataSpecialDeal {
	 ...
	 * @param aim_fields
	 * @param metaVO TODO
	 * @param dataV,tablevo为源数据和原数据对应的表结构
	 * @throws Exception
	 */
     ...
     * @throws Exception
     */
    public String specialDealAfterImportSuccess(String[] aim_fields, List dataV,
            Map hm_tablevo, String tablename, Map ht, DataImportVO metaVO) throws Exception;
