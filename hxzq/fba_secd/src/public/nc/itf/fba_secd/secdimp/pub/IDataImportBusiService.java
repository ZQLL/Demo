...
public interface IDataImportBusiService {
	...
	* 删除重复的行情
	 ...
	 * @throws BusinessException
	 */
	public void delete(String pk_securities, String trade_date) throws BusinessException;
	 ...
	 * 查询当前证券的行情
	 * **/
	public Map queryData(String pk_securities, String trade_date) throws BusinessException;
