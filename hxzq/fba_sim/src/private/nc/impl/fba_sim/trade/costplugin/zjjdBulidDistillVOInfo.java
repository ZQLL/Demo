...
//		distilvo.setModifier(modifier);
	 ...
	 * 构造应收利息计提单据---转出、买入、卖出
	 */
	public InterestdistillVO buildInterestdistill(ICostingTool costingtool,	StockBalanceVO stockbalancevo,ZqjdVO vs) 
		...
		distilvo.setState(SystemConst.statecode[1]);
		distilvo.setStocks_num(vs.getBargain_num().sub(stockbalancevo.getBargain_num()==null?new UFDouble(0):stockbalancevo.getBargain_num()));
