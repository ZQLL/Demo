...
public class ZqjdTallyServiceImpl implements IZqjdTallyService {
	...
	@Override
	public void saveBuyTally(ITrade_Data tradeVO, UFDouble sellscost) throws BusinessException {
		
		ZqjdTallyVO tallyVO = buildBaseTallyVOFromTradeVO(tradeVO);

		UFDouble factor = new UFDouble(-1);

		tallyVO.setBargain_num(SafeCompute.multiply(tallyVO.getBargain_num(), factor));
	...
	private void deleteTally(ITrade_Data tradeVO) throws DAOException {
		...
		condition.append(" srcbillno = '").append(tradeVO.getBillno()).append("'");
...
//		tallyVO.setPk_assetsprop(nc.vo.fba_scost.cost.pub.SystemConst.Pk_AssetsProp1);
	...
	@Override
	public ZqjdTallyVO gatherSellBuyBalance(ITrade_Data tradeVO) throws BusinessException {
		// 查询参数
