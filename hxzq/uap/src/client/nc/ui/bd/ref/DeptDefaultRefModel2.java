...
public class DeptDefaultRefModel2
  extends AbstractRefTreeModel
{
  ...
  public void reset()
  {
    ...
    setFieldName(new String[] {
      NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0003279"), 
    ...
    setHiddenFieldCode(new String[] { "pk_dept", "pk_fatherorg", "displayorder", "innercode" });
    ...
    setTreeIconPolicy(new OrgTreeCellRendererIconPolicy(
      "Department"));
  }
  ...
  protected String getEnvWherePart()
  {
    ...
    try
    {
      ...
      sql = "(pk_group = '" + getPk_group() + "' and " + "pk_org" + " = '" + pk_org + "')";
    }
    catch (Exception e)
    {
