...
public class AppletViewer extends JFrame {
	...
	public AppletViewer(String protocol, String server, int port) throws HeadlessException {
		super();
	...
	public AppletViewer(String protocol, String server, int port, String file) throws HeadlessException {
		super();
		this.protocol = protocol;
		this.server = server;
		this.port = port;
	...
	private void initialize() {
		...
		JPanel panel = new JPanel(){
			...
			public void doLayout() {
				...
				progressPanel.setBounds((size.width-progSize.width)/2, (size.height-progSize.height)/2, progSize.width, progSize.height);
			}
...
//		String urlstr = protocol+"://"+server+":"+port+"/service/ncstarterservlet";
