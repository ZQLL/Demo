 ...
 * 
 */
public class ScostTransformBulidDistillVOInfo {
	...
	public InterestdistillVO buildInterestdistill(ICostingTool costingtool,
		...
		distilvo.setStocks_num(vs.getBargain_num().sub(
				vs.getBargain_num() == null ? new UFDouble(0) : vs
						.getBargain_num()));
		...
		distilvo.setPk_costplan(costingtool.getCostParaVO().getCostplanvo()
				.getPk_costplan());
		distilvo.setPk_glorgbook(vs.getPk_glorgbook());
		distilvo.setPk_assetsprop(vs.getHc_pk_assetsprop());
		distilvo.setPk_stocksort(vs.getPk_stocksort());
		distilvo.setPk_capaccount(vs.getHc_pk_capaccount());
		distilvo.setPk_client(vs.getPk_client());
		distilvo.setPk_operatesite(vs.getPk_operatesite());
		distilvo.setPk_partnaccount(vs.getPk_partnaccount());
		distilvo.setPk_selfsgroup(vs.getPk_selfsgroup());
