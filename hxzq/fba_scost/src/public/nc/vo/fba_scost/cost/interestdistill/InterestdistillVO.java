...
return (UFLiteralDate) this.getAttributeValue( InterestdistillVO.END_DATE);
 } 

/** 
* 设置限售结束日期
*
* @param end_date 限售结束日期
*/
...
return (UFLiteralDate) this.getAttributeValue( InterestdistillVO.BEGIN_DATE);
 } 

/** 
* 设置限售开始日期
*
* @param begin_date 限售开始日期
*/
...
return (UFDateTime) this.getAttributeValue( InterestdistillVO.APPROVEDATE);
 } 
...
return (UFDateTime) this.getAttributeValue( InterestdistillVO.CREATIONTIME);
 } 
...
return (UFDouble) this.getAttributeValue( InterestdistillVO.INTERESTDISTILL);
 } 

/** 
* 设置本期利息计提
*
* @param interestdistill 本期利息计提
*/
public void setInterestdistill ( UFDouble interestdistill) {
this.setAttributeValue( InterestdistillVO.INTERESTDISTILL,interestdistill);
 } 
...
return (UFDateTime) this.getAttributeValue( InterestdistillVO.MODIFIEDTIME);
 } 
...
return (String) this.getAttributeValue( InterestdistillVO.PK_INTERESTDISTILL);
 } 

/** 
* 设置主键
*
* @param pk_interestdistill 主键
*/
public void setPk_interestdistill ( String pk_interestdistill) {
this.setAttributeValue( InterestdistillVO.PK_INTERESTDISTILL,pk_interestdistill);
 } 
...
return (String) this.getAttributeValue( InterestdistillVO.PK_OPERATESITE);
 } 

/** 
* 设置分户地点
*
* @param pk_operatesite 分户地点
*/
...
return (String) this.getAttributeValue( InterestdistillVO.PK_PARTNACCOUNT);
 } 

/** 
* 设置股东账号
*
* @param pk_partnaccount 股东账号
*/
public void setPk_partnaccount ( String pk_partnaccount) {
this.setAttributeValue( InterestdistillVO.PK_PARTNACCOUNT,pk_partnaccount);
 } 
...
this.setAttributeValue( InterestdistillVO.VDEF9,vdef9);
  ...
  public IVOMeta getMetaData() {
    return VOMetaFactory.getInstance().getVOMeta("fba_scost.sim_interestdistill");
  }
}