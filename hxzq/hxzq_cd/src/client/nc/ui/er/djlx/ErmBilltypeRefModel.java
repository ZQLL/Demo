...
public class ErmBilltypeRefModel
  extends AbstractRefModel
{
  final String wherePart = " systemcode = 'erm' and pk_billtypecode like '26%' and istransaction = 'N' and (pk_group='" + getPk_group() + "' or pk_org = '" + "GLOBLE00000000000000" + "')";
  ...
  {
    return new String[] { NCLangRes4VoTransl.getNCLangRes().getStrByID("ersetting_0", "02011001-0032"), NCLangRes4VoTransl.getNCLangRes().getStrByID("ersetting_0", "02011001-0033"), NCLangRes4VoTransl.getNCLangRes().getStrByID("ersetting_0", "02011001-0034") };
  }
  ...
  {
    return NCLangRes4VoTransl.getNCLangRes().getStrByID("ersetting_0", "02011001-0035");
  }
