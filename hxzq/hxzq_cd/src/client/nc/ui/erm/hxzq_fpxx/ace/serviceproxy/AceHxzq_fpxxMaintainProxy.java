 ...
 * @author duy
 */
public class AceHxzq_fpxxMaintainProxy 
             implements 
    ...
    public Object[] queryByQueryScheme(IQueryScheme queryScheme) throws Exception {
        nc.itf.erm.hxzq_fpxx.IHxzq_fpxxMaintain query = NCLocator.getInstance().lookup(nc.itf.erm.hxzq_fpxx.IHxzq_fpxxMaintain.class);
