...
public class FundTallyVO extends SuperVO {
    ...
    public String getProductorcounterparty() {
        return (String) this.getAttributeValue(FundTallyVO.PRODUCTORCOUNTERPARTY);
    }
    ...
    public void setProductorcounterparty(String productorcounterparty) {
        this.setAttributeValue(FundTallyVO.PRODUCTORCOUNTERPARTY, productorcounterparty);
    }
