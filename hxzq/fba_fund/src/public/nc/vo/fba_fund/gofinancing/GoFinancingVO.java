...
return (String) this.getAttributeValue( GoFinancingVO.ORIGINAL_ENTRUSTCONTRACT);
 } 

/** 
* 设置原委托合同
*
* @param original_entrustcontract 原委托合同
*/
public void setOriginal_entrustcontract ( String original_entrustcontract) {
this.setAttributeValue( GoFinancingVO.ORIGINAL_ENTRUSTCONTRACT,original_entrustcontract);
 } 
...
return (String) this.getAttributeValue( GoFinancingVO.PRODUCTORCOUNTERPARTY);
 } 

/** 
* 设置产品或对手方名称
*
* @param productorcounterparty 产品或对手方名称
*/
public void setProductorcounterparty ( String productorcounterparty) {
this.setAttributeValue( GoFinancingVO.PRODUCTORCOUNTERPARTY,productorcounterparty);
 } 
