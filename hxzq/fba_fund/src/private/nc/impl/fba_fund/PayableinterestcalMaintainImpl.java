...
public class PayableinterestcalMaintainImpl extends AcePayableinterestcalPubServiceImpl implements IPayableinterestcalMaintain {

    @Override
    public PayableInterestCalVO[] query(IQueryScheme queryScheme) throws BusinessException {
    ...
    public BatchOperateVO batchSave(BatchOperateVO batchVO) throws BusinessException {
        ...
        List<FundTallyVO> tallyList = (List<FundTallyVO>) ((PayableInterestCalVO) addVOs[0]).getObj();
