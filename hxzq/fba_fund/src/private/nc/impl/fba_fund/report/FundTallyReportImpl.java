...
public class FundTallyReportImpl implements IFundTallyReport {
     ...
     */
    private List<FundTallyReportVO> processData(List<FundTallyVO> vos, ConditionVO[] conVos) throws BusinessException {
     ...
     */
    private FundTallyReportVO buildReportVO(List<FundTallyVO> tallylist, ConditionVO[] conVos) throws BusinessException {
